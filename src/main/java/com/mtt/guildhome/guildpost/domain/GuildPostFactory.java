...
public class GuildPostFactory {
	...
	public static GuildPost reconstitutePost(String id, String guildId, String userId, String contentSneakpeak) {
		return new GuildPost(id, guildId, userId, null, contentSneakpeak);
	}

	public static GuildPost reconstitutePost(String id, String guildId, String userId, String content,
